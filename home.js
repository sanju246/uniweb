...
$jscomp.polyfillIsolated = function(a, b, e, f) {
    ...
    null != b && (a ? $jscomp.defineProperty($jscomp.polyfills, h, {
        ...
        writable: !0,
        value: b
    }) : b !== e && ($jscomp.propertyToPolyfillSymbol[h] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(h) : $jscomp.POLYFILL_PREFIX + h,
...
var scrollCue = function() {
    var a = {}, b, e, f = 0, h = !0, k = !0, l = !1, n = !1, m, p = {
        duration: 600,
        interval: -.7,
        percentage: .75,
        enable: !0,
    ...
    a = {
        ...
        setOptions: function(g, c) {
            ...
            if ("undefined" !== typeof g)
                return Object.keys(g).forEach(function(b) {
                    "[object Object]" === Object.prototype.toString.call(g[b]) ? d[b] = a.setOptions(g[b], c[b]) : (d[b] = g[b],
        ...
        searchElements: function() {
            ...
            if (l)
                for (g = docSlider.getElements().pages.length,
                c = 0; c < g; c++)
                    for (d = document.querySelectorAll('[data-ds-index="' + c + '"] [data-cue]:not([data-scpage])'),
                    e = 0; e < d.length; e++)
        ...
        runQuery: function() {
            ...
            d++)
                if (c.$jscomp$loop$prop$elms$6 = e[b[d]],
